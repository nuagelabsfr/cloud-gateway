...
ELSE (NL_LIBRARIES AND NL_INCLUDE_DIRS )
  ...
  IF ( NL_INCLUDE_DIR )
    ...
    FIND_LIBRARY( NL_STATIC_LIBRARY
      NAMES
        libnl-3.a
      PATH_SUFFIXES
        lib64 lib
    ...
    FIND_LIBRARY( NLGENL_STATIC_LIBRARY
      NAMES
        libnl-genl-3.a
      PATH_SUFFIXES
        lib64 lib
    ...
    FIND_LIBRARY( NLROUTE_STATIC_LIBRARY
      NAMES
        libnl-route-3.a
      PATH_SUFFIXES
        lib64 lib
...
IF(NL_FOUND)
  ...
  SET( NL_STATIC_LIBRARIES ${NLGENL_STATIC_LIBRARY} ${NLROUTE_STATIC_LIBRARY} ${NL_STATIC_LIBRARY} )
...
MARK_AS_ADVANCED( NL_LIBRARIES NL_STATIC_LIBRARIES NL_INCLUDE_DIRS )
