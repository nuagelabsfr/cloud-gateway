...
{
    fprintf(stderr, "Usage: CloudGatewayRemoveInstance [OPTIONS]\n");
...
#include "cg_config_remove_instance.itm"
#undef ITEM
                ...
                if (result == 0)
                {
                    ...
                    if (result == 0)
                    {
                        ...
                        else
                        {
                            ...
                            fprintf(stderr, "Error removing instance %s: %s\n",
                                    instance_name,
                                    strerror(result));
                        }
                    }
                    ...
                    {
                        fprintf(stderr, "There is no instance %s.\n",
                                instance_name);
                    }
                    else
                    {
