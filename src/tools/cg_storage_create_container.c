...
static int container_creation_cb(int const status,
                                 void * const cb_data)
{
    int result = status;
         ...
         char const ** const argv)
{
                    ...
                    if (result == 0)
                    {
                        ...
                        if (result == 0)
                        {
                            ...
                            if (result == 0)
                            {
                                ...
                                {
                                    fprintf(stderr,
                                            "Error creating container %s on instance %s: %s\n",
                                            container_name,
                                            instance_name,
                                            strerror(result));
                                }
    ...
    {
        fprintf(stderr,
                "%s <Cloud Gateway configuration file> <Storage/Instance Name> <New Container Name>\n",
                argv[0]);
    }
